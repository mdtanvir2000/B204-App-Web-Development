            ...
            sx={{alignItems:"center", justifyContent:"space-between"}}>
             <Grid item xs={6}>
                  <div className="flex items-center space-x-4">
                    <img className="w-[5rem] h-[5rem] object-cover object-top" src="https://chasehaul.com/cdn/shop/files/3_copy_6f428fde-1f24-4652-9a6e-e5d6b3d1ede0.jpg?v=1720179504" alt="" />
