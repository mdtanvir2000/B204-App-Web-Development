...
import { colors, FormControl, FormControlLabel, FormLabel, Pagination, RadioGroup } from '@mui/material'
...
export default function Product() {
 ...
 useEffect(()=>{
  ...
  const [minPrice, maxPrice]=priceValue===null?[0,0] :
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div className="lg:col-span-4 w-full">
                <div className='flex flex-wrap justify-center bg-white py-5'>
                  {/* {products.products && product.products?.content?.map((item) => */}
                    {mens_kurta.map((item)=>
          ...
          <section className='w-full px=[3.6rem]'>
            <div className='px-4 py-5 justify-center'>
              {/* <Pagination count={ProductDetails.products?.totalPages} color='secondary'/> */}
